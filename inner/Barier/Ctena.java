...
public class Ctena extends Barier {
    ...
    public boolean yslovie(Ychasnik ychasnik) {
        ...
        ychasnik.jump();
        if (this.CtenaLength <= ychasnik.CtenaHeight()) {
            System.out.println(ychasnik.nameYchasnik() + " успешно преодолел барьер!");
            return true;
        } else {
            System.out.println(ychasnik.nameYchasnik() + " не смог преодолеть барьер...");
            return false;
        }
    }
}